...
public class PathController {
	...
	public List<Entity> traversePath(Resource resource, Entity resourcePath,
			...
			throws ResourceInterfaceException {
		logger.log(Level.FINEST, "traversePath() resource:"+resource.getName()+" resourcePath:"+resourcePath.toString());
		
		if (resource.getImplementingInterface() == null) {
			logger.log(Level.FINEST, "traversePath() is an interface implementing NULL");
		}
		...
		logger.log(Level.FINEST, "traversePath() returning NULL");
		return null;
	}
